create ot replace database demo_db;
...
ALTER TABLE IF EXISTS CUSTOMERS MODIFY COLUMNS (phone,full_name)
SET MASKING POLICY PHONE;

-- assign roles to a user
GRANT ROLE ANALYST_MASKED TO USER MAYANK;
GRANT ROLE ANALYST_FULL TO USER MAYANK;
